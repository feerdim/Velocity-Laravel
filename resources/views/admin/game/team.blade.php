@extends('layouts.app', ['title' => 'Games', 'link' => 'admin.game.index', 'subTitle' => $game->name . ' | team'])
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="ml-3">TEAM | Type</h4>
                    </div>
                    @can('teams.create')
                        <div class="input-group-prepend">
                            <a href="{{ route('admin.team.create', ['game'=> $game->id, 'team' => $game->team->id]) }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                        </div>
                    @endcan
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-flush" id="datatable-basic">
                            ...
                            <tbody>
                                @forelse ($game->team->types()->withPivot('id')->get() as $type)
                                    <tr class="text-center">
                                        <td>{{ $type->name }}</td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <form action="{{ route('admin.team.destroy') }}" method="POST">
                @csrf
                @method("DELETE")
                    <input id="team_name" type="hidden" name="id">
...
<script>
    function SaveId(id) {
        document.getElementById("team_name").value = id
    }
</script>
@endsection