@extends('layouts.app', ['title' => 'Team Schedules', 'link' => 'admin.team_schedule.index'])
                                  ...
                                  <tr>
                                      ...
                                      <td class="d-flex flex-wrap">
                                        ...
                                        @forelse ($game_in_schedule->values()->all() as $player_schedule)
                                          <a href="{{ route('admin.team_schedule.showDetail', ['team_schedule' => $player_schedule->id, 'game' => $player_schedule->game_id, 'type' => $player_schedule->type_id ]) }}" class="btn btn-default mr-4">
                                            <span>{{ $player_schedule->game->name }} | 
                                                {{-- {{ $player_schedule->game->team->types}} --}}
                                                {{ $player_schedule->game->team->types->where('id', '=', $player_schedule->type_id)->first()->name }}
                                            </span>
